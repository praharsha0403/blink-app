				...
				>
					{isRecording() ? (
						...
						<>
							...
							{/* Instant mode limit text removed */}
							{rawOptions.mode === "instant"
								? "Start recording"
								: "Start recording"}
						</>
...
function createUpdateCheck() {
	...
	onMount(async () => {
		...
		const shouldUpdate = await dialog.confirm(
			`Version ${update.version} of Blink is available, would you like to install it?`,
			{ title: "Update Blink", okLabel: "Update", cancelLabel: "Ignore" },
		);
